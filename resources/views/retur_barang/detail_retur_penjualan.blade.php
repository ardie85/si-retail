        ...
        <table style="width:100%">
            <tr>
                <td style="width:33.3%">
                    ...
                    <select class="form-control" style="display: inline-block; width: 50%;" name="Pelanggan" value="" disabled>
                        <option>{{$returpenjualan[0]->c_nama}}</option>
                    </select>
                ...
                <td style="width:33.3%">
                    ...
                    <div class="input-group date" id="reservationdate" data-target-input="nearest" style="display: inline-block; width: 50%;">
                        <input type="text" class="form-control" name="pengguna" value="{{$returpenjualan[0]->p_nama}}" disabled />
                    </div>
...
<div class="card-footer" style="display: inline-flex;position: relative;">
    <a href="{{ url('retur_penjualan/')}}"><small class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Kembali</small></a>
</div>
@endsection